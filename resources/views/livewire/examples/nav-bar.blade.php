<!-- Navbar -->
<nav class="navbar navbar-expand-lg navbar-light bg-body-tertiary mb-2">
    <!-- Container wrapper -->
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item">
                    <a wire:navigate class="{{request()->is('/counties') ? 'nav-link active' : 'nav-link'}}" href="/counties">Counties</a>
                </li>
                <li class="nav-item">
                    <a wire:navigate class="{{request()->is('/fileUpload') ? 'nav-link active' : 'nav-link'}}" href="/fileUpload">File Upload</a>
                </li>
                <li class="nav-item">
